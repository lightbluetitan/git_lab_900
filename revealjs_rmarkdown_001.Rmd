...
```{r ggplot2,fig.align='center',out.width="60%"}
...
```{r lattice,fig.align='center',out.width="60%"}
...
```{r cyl_gear,fig.align='center',out.width="60%"}
...
```{python,results='hide',collapse=TRUE,fig.align="center",out.width="60%"}
...
```{python,results='hide',collapse=TRUE,out.width="60%",fig.align="center"}
...
<iframe width="800" height="500" src="https://www.youtube.com/embed/jPre6LVvr5Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen data-external=1></iframe>
